...
\pause
    	...
    	\begin{center}
\scalebox{0.5}{\input{09_cv_reg_auto/figure/blackbox_HPO}}
    	\end{center}
...
\bigskip
    ...
    \begin{figure}
        ...
        \centering
        \only<1>{
            \includegraphics[width=0.95\textwidth]{09_cv_reg_auto/figure/IntroPlots_Obs.pdf}
        }\only<2>{
            \includegraphics[width=0.95\textwidth]{09_cv_reg_auto/figure/IntroPlots_GP.pdf}
        }\only<3>{
            \includegraphics[width=0.95\textwidth]{09_cv_reg_auto/figure/IntroPlots_Acqui.pdf}
        }\only<4->{
            \includegraphics[width=0.95\textwidth]{09_cv_reg_auto/figure/IntroPlots_Complete.pdf}
        }
    \end{figure}
...
\begin{figure}
    \vspace{-1em}
    \centering
    \onslide<1->{\includegraphics[width=0.8\textwidth]{09_cv_reg_auto/figure/IntroPlots_Iter2.pdf}}
    \onslide<2->{\includegraphics[width=0.8\textwidth]{09_cv_reg_auto/figure/IntroPlots_Iter3.pdf}}
    \onslide<3->{\includegraphics[width=0.8\textwidth]{09_cv_reg_auto/figure/IntroPlots_Iter4.pdf}}
\end{figure}
\end{columns}
